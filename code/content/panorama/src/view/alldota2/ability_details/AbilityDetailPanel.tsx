...
export class AbilityDetailPanel extends BasePureComponent<IProps> {
    ...
    render() {
        const [abtest, forceRefresh] = useState([]);
        let toggleClass: { [x: string]: any; } = {};
        let dialogVariables: { [x: string]: any; } = {};
        toggleClass['DescriptionOnly'] = this.props.mode == "description_only";
        toggleClass['ShowScepterOnly'] = this.props.mode == "show_scepter_only";
        ...
        toggleClass['NoAbilityData'] = this.props.abilityname == "" || tData == undefined || tData == null;

        tData = tData || {};

        let bIsEnemy = Entities.IsEnemy(this.props.entityindex);
        ...
        onlynowlevelvalue = onlynowlevelvalue || (finiteNumber(Number(tData.OnlyShowNowLevelValue)) == 1);
        ...
        if (toggleClass['ScepterUpgradable']) {
            ...
            if (sScepterUpgradeDescription != "#DOTA_Tooltip_ability_" + abilityname + "_aghanim_description") {
                ...
                sScepterUpgradeDescription = replaceValues({ sStr: sScepterUpgradeDescription, bShowExtra: showextradescription, sAbilityName: abilityname, iLevel: iLevel, iEntityIndex: entityindex, bOnlyNowLevelValue: onlynowlevelvalue });
        ...
        sExtraDescription = replaceValues({ sStr: sExtraDescription, bShowExtra: showextradescription, sAbilityName: abilityname, iLevel: iLevel, iEntityIndex: entityindex, bOnlyNowLevelValue: onlynowlevelvalue });
        ...
        for (let i = 0; i < aValueNames.length; i++) {
            ...
            let bRequiresScepter = (Number(GetSpecialValueProperty(abilityname, sValueName, "RequiresScepter", entityindex)) || 0) == 1;
            ...
            if (sValueLocalize != sValueDescription) {
                ...
                if (bHasSign) {
                    let sSign = sValueLocalize.substr(0, 1);
                    sValueLocalize = sValueLocalize.substr(1);
        ...
        useEffect(() => {
            let listener: GameEventListenerID;
            if (iAbilityIndex != -1) {
        ...
        return (
            ...
            <Panel className={CSSHelper.ClassMaker("AbilityDetails", toggleClass)} {...other} ref={refSelf} dialogVariables={dialogVariables}>
                <Panel id="Header">
                    <DOTAItemImage id="ItemImage" itemname={this.props.abilityname} />
                    <Panel id="HeaderLabels">
                        <Panel id="AbilityHeader">
                            <Label id="AbilityName" className="TitleFont" text={$.Localize("#DOTA_Tooltip_ability_" + this.props.abilityname)} html={true} />
                ...
                <Panel id="AbilityCoreDetails">
                    ...
                    <Label id="AbilityLore" className={classNames({ 'Hidden': $.Localize("#" + sLore) == "#" + sLore || $.Localize("#" + sLore) == "" })} localizedText="#DOTA_AbilityTooltip_Lore" html={true} />
