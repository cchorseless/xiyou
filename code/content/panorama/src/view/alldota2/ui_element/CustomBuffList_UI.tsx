...
export class CustomBuffList_UI extends BaseEasyPureComponent {
    ...
    render() {
        return (
            this.__root___isValid && (
                <Panel
                    id="BuffContainer"
                    key="compId_1" className="root" ref={this.__root__} style={this.CSS_0_0} {...this.props} {...this.__root___attrs}>
                    {this.props.children}
