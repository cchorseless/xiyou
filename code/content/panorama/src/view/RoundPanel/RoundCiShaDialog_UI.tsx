...
export class RoundCiShaDialog_UI extends BasePureComponent {
...
lbl_cishades: React.RefObject<LabelPanel>;
NODENAME = {  __root__: '__root__',  btn_end: 'btn_end',  lbl_tips: 'lbl_tips',  panel_0: 'panel_0',  panel_9: 'panel_9',  panel_1: 'panel_1',  panel_2: 'panel_2',  panel_3: 'panel_3',  panel_8: 'panel_8',  panel_7: 'panel_7',  panel_6: 'panel_6',  panel_4: 'panel_4',  panel_5: 'panel_5',  lbl_cishades: 'lbl_cishades',  };
...
this.lbl_cishades = createRef<LabelPanel>();
...
CSS_2_11 : Partial<VCSSStyleDeclaration>  = {"y":"345px","height":"40px","fontWeight":"bold","fontSize":"30","color":"#f9f4f4","x":"0px","horizontalAlign":"middle"}
...
lbl_cishades_isValid:boolean = true;
lbl_cishades_attrs:LabelAttributes={};
lbl_cishades_childs: Array<JSX.Element> = [];

render() {
    return(
        this.__root___isValid && 
<Panel key="compId_1" ref={this.__root__} style={this.CSS_0_0}  {...this.props}   {...this.__root___attrs}>
    <Label text="刺杀领袖" key="compId_13" style={this.CSS_1_0} >
</Label>
...
<Button ref={this.btn_end} onactivate={this.onbtn_makeTeam} key="compId_14" style={this.CSS_1_1}  {...this.btn_end_attrs}>
        <Label text="进行刺杀" key="compId_15" style={this.CSS_2_0} >
</Label>
...
<Label text="刺杀对方领袖获取最终胜利" ref={this.lbl_tips} key="compId_46" style={this.CSS_2_0_0}  {...this.lbl_tips_attrs} >
...
{this.panel_5_childs}
        ...
        {this.lbl_cishades_isValid && 
<Label text="刺杀领袖" ref={this.lbl_cishades} key="compId_65" style={this.CSS_2_11}  {...this.lbl_cishades_attrs} >
{this.lbl_cishades_childs}
</Label>
}
