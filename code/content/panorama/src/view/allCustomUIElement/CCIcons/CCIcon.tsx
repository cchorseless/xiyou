...
export class CCIcon<T = {}> extends CCPanel<ImageAttributes & ICCIcon & T, ImagePanel> {
	...
	// };
	defaultClass = () => { return CSSHelper.ClassMaker(this.props.className, "EOM_Icon", { EOM_IconSpin: this.props.spin || this.props.spinDuration, EOM_IconShadow: this.props.shadow }); };
	defaultStyle = () => {
		return {
