...
NODENAME = {  __root__: '__root__',  btn_debug: 'btn_debug',  panel_allpanel: 'panel_allpanel',  panel_alldialog: 'panel_alldialog',  };
...
CSS_1_1 : Partial<VCSSStyleDeclaration>  = {"x":"0px","horizontalAlign":"middle","y":"0px","verticalAlign":"middle"}
...
<Panel ref={this.panel_allpanel} className="root" key="compId_13" style={this.CSS_1_1}  {...this.panel_allpanel_attrs} >
{this.panel_allpanel_childs}
</Panel>
}
    {this.panel_alldialog_isValid && 
<Panel ref={this.panel_alldialog} className="root" key="compId_16" style={this.CSS_1_2}  {...this.panel_alldialog_attrs} >
