...
export interface ICCButton {
	 ...
	 * */
	type?: "Default" | "Empty" | "Primary" | "Bevel" | "Store" | "Text" | "Outline" | "Tui6" | "Tui7" | "Tui3" | "Style1";
	/** 设置按钮颜色 */
...
export class CCButton extends CCPanel<TextButtonAttributes & ICCButton, TextButton> {
	defaultClass() { return CSSHelper.ClassMaker(this.props.className, "CC_Button", { [this.props.type!]: (this.props.type != "Empty") }, this.props.color, { Loading: this.props.loading }); };
	static defaultProps = {
		/** 设置按钮载入状态 */
		loading: false,
		/** 设置按钮类型 */
