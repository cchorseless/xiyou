...
export class Task_FinishTaskDialog_UI extends BasePureComponent {
...
CSS_1_0 : Partial<VCSSStyleDeclaration>  = {"y":"36px","x":"9px","width":"143px","height":"51px","fontWeight":"bold","fontSize":"35","color":"#f9f4f4"}
...
<Label text="任务完成" ref={this.lbl_task_progress} key="compId_2" style={this.CSS_1_0}  {...this.lbl_task_progress_attrs} >
