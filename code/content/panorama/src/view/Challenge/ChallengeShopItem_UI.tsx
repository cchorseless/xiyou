...
export class ChallengeShopItem_UI<T extends NodePropsData> extends BasePureComponent<T> {
    ...
    CSS_1_1: Partial<VCSSStyleDeclaration> = { "y": "200px", "x": "4px", "width": "180px", "height": "100px", "backgroundRepeat": "no-repeat", "backgroundImage": "url(\"file://{images}/common/btn_lvuppopu.png\")", "backgroundSize": "100% 100%" }
    ...
    CSS_1_2: Partial<VCSSStyleDeclaration> = { "y": "200px", "x": "185px", "width": "180px", "height": "100px", "backgroundRepeat": "no-repeat", "backgroundImage": "url(\"file://{images}/common/btn_lvuptec.png\")", "backgroundSize": "100% 100%" }
    ...
    CSS_1_3: Partial<VCSSStyleDeclaration> = { "y": "199px", "x": "365px", "width": "140px", "height": "100px", "backgroundRepeat": "no-repeat", "backgroundImage": "url(\"file://{images}/common/btn_shop.png\")", "backgroundSize": "100% 100%" }
