export module QRcodeHelper {
  ...
  export class QRCode {
     ...
     * @returns
     */
    static createQRCode(data: string, qrcodesize: number = 200) {
      ...
      // let qrcodeHome = new Laya.Sprite();
      // qrcodeHome.width = pix_size;
      // qrcodeHome.height = pix_size;
      // for (let row = 0; row < size; ++row) {
      //   for (let col = 0; col < size; ++col) {
      //   //   let sc = new Laya.Sprite();
      //   //   qrcodeHome.addChild(sc);
      //     let b = qrcode.isDark(row, col) ? "#ffffff" : "#000000";
      //     qrcodeHome.graphics.drawRect(
      //       col * pix_size,
      //       row * pix_size,
      //       pix_size,
      //       pix_size,
