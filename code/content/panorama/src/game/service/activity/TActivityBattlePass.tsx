...
export class TActivityBattlePass extends TActivity {
    ...
    public VipItems: Dictionary<number, ValueTupleStruct<number, number>> = new Dictionary<
        number,
        ValueTupleStruct<number, number>
    >();

    public set _VipItems(data: Dictionary<number, ValueTupleStruct<number, number>>) {
        this.VipItems.copy(data);
    }
}