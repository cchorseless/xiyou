...
//         let enemy_table :IBaseNpc_Plus[]= []
//         table.insert(enemy_table, target);
//         let enemy_table_string = TableToStringCommaEnt(enemy_table);
...
//             let ability = this;
//             let particle_projectile = "particles/units/heroes/hero_bounty_hunter/bounty_hunter_suriken_toss.vpcf";
//             let enemy_table_string = extradata.enemy_table_string;
//             let enemy_table = StringToTableEnt(enemy_table_string, ",");
...
//                     this.GetCasterPlus().ModifyGold(actual_gold_to_steal, false, EDOTA_ModifyGold_Reason.DOTA_ModifyGold_Unspecified);
//                     SendOverheadEventMessage(this.GetCasterPlus(), DOTA_OVERHEAD_ALERT.OVERHEAD_ALERT_GOLD, this.GetCasterPlus(), actual_gold_to_steal, undefined);
...
//             this.particle_hook = "particles/hero/bounty_hunter/shuriken_toss_hook.vpcf";
...
//         if (IsServer()) {
//             let distance = (this.parent.GetAbsOrigin() - this.toss_hit_location).Length2D();
//             let direction = (this.toss_hit_location - this.parent.GetAbsOrigin()).Normalized();
...
//         }
//     }
//     ShadowJaunt(caster: IBaseNpc_Plus, ability, target: IBaseNpc_Plus) {
//         if (caster.GetTeamNumber() != target.GetTeamNumber()) {
//             if (target.TriggerSpellAbsorb(ability)) {
//                 return undefined;
//             }
//         }
//         let blink_direction = (target.GetAbsOrigin() - caster.GetAbsOrigin()).Normalized();
...
//         if (!this.GetParentPlus().PassivesDisabled() && keys.target && keys.target.GetTeamNumber() != this.GetParentPlus().GetTeamNumber()) {
...
//                     }
//                     target.ModifyGold(-actual_gold_to_steal, false, EDOTA_ModifyGold_Reason.DOTA_ModifyGold_Unspecified);
//                     attacker.ModifyGold(actual_gold_to_steal, false, EDOTA_ModifyGold_Reason.DOTA_ModifyGold_Unspecified);
//                     SendOverheadEventMessage(attacker, DOTA_OVERHEAD_ALERT.OVERHEAD_ALERT_GOLD, attacker, actual_gold_to_steal, undefined);
//                     if (this.GetCasterPlus().HasModifier("modifier_imba_jinada_gold_tracker")) {
//                         this.GetCasterPlus().findBuff<modifier_imba_jinada_gold_tracker>("modifier_imba_jinada_gold_tracker").SetStackCount(this.GetCasterPlus().FindModifierByName("modifier_imba_jinada_gold_tracker").GetStackCount() + actual_gold_to_steal);
//                     }
//                 }
...
//     OnIntervalThink(): void {
//         this.SetStackCount(this.parent.GetGold());
...
//                 //     return undefined;
//                 // }
//                 this.caster.ModifyGold(this.bonus_gold_self, true, EDOTA_ModifyGold_Reason.DOTA_ModifyGold_Unspecified);
//                 SendOverheadEventMessage(this.caster, DOTA_OVERHEAD_ALERT.OVERHEAD_ALERT_GOLD, this.caster, this.bonus_gold_self, undefined);
...
//                     this.caster.ModifyGold(this.contract_gold, true, EDOTA_ModifyGold_Reason.DOTA_ModifyGold_Unspecified);
//                     SendOverheadEventMessage(this.caster, DOTA_OVERHEAD_ALERT.OVERHEAD_ALERT_GOLD, this.caster, this.contract_gold, undefined);
