...
@registerAbility()
export class ability1_skeleton_king_hellfire_blast extends ActiveRootAbility {
    /**对应dota内的名字 */
    ...
    OnSpellStart() {
        ...
        let _type = GGetRegClass<typeof ability2_skeleton_king_vampiric_aura>("ability2_skeleton_king_vampiric_aura");
    ...
    EOM_GetModifierIgnorePhysicalArmorPercentageTarget(params: IModifierTable) {
        if (IsServer() && this.bUseEnergy) {
            ...
            if (params.attacker == this.GetCasterPlus()) {
                ...
                //  小骷髅无视护甲
                let _type = GGetRegClass<typeof modifier_skeleton_king_2_summon>("modifier_skeleton_king_2_summon");
