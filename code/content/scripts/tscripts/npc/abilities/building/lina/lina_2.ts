...
import { lina_1 } from "./lina_1";
import { lina_3, modifier_lina_3_fiery_soul } from "./lina_3";

/** dota原技能数据 */
export const Data_lina_light_strike_array = {
    ID: "5041",
    ...
    AbilitySpecial: {
        "01": { var_type: "FIELD_INTEGER", light_strike_array_aoe: "250" },
        "02": { var_type: "FIELD_FLOAT", light_strike_array_delay_time: "0.5" },
        "03": { var_type: "FIELD_FLOAT", light_strike_array_stun_duration: "1.6 1.9 2.2 2.5" },
        "04": { var_type: "FIELD_INTEGER", light_strike_array_damage: "80 130 180 230", LinkedSpecialBonus: "special_bonus_unique_lina_3" },
    },
    AbilityCastAnimation: "ACT_DOTA_CAST_ABILITY_2",
};

@registerAbility()
export class lina_2 extends BaseAbility_Plus {
    /**对应dota内的名字 */
...
export class modifier_lina_2_thinker extends modifier_particle_thinker {
    ...
    BeRemoved(): void {
        ...
        if (IsServer()) {
            ...
            if (hCaster.HasTalent(sTalentName) && IsValid(lina1) && lina1.GetLevel() > 0 && type(lina1.DragonSlave) == "function") {
