...
export class modifier_lycan_1 extends BaseModifier_Plus {
    ...
    OnIntervalThink() {
        if (IsServer()) {
            ...
            // if (IsValid(modifier_lycan_3_form as IBaseModifier_Plus)) {
...
export class modifier_lycan_1_summon extends BaseModifier_Plus {
    ...
    OnIntervalThink() {
        if (IsServer()) {
            ...
            if (!IsValid(this.hAttackTarget) || CalcDistanceBetweenEntityOBB(hCaster, this.hAttackTarget) > this.wolf_max_range) {
                this.hAttackTarget = null
...
export class modifier_lycan_1_summon_charge extends BaseModifier_Plus {
    ...
    BeCreated(params: IModifierTable) {
        ...
        if (IsServer()) {
            ...
            if (!IsValid(this.hTarget) || !this.hTarget.IsAlive()) {
                this.Destroy()
                return
            }
