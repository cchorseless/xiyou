...
export class ability2_void_spirit_dissimilate extends BaseAbility_Plus {
    ...
    ActiveOne() {
        ...
        let hCaster = this.GetOriCaster() as IBaseNpc_Plus & { hParent: IBaseNpc_Plus, IsDummy: boolean, tIlls: any[], iActiveCount: number, iActivePct: number, iDamagePct: number, all_damage_amplify: number };
