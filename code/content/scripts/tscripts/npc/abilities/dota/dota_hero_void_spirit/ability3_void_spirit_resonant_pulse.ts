    ...
    UseSpell() {
        ...
        let DamageRadius = () => {
            let hEnemies = FindUnitsInRadius(
                ...
                false);
            for (let hTarget of (hEnemies as IBaseNpc_Plus[])) {
...
export class modifier_void_spirit_2 extends BaseModifier_Plus {
    ...
    OnIntervalThink() {
        ...
        let hCaster = hAbility.GetCasterPlus() as IBaseNpc_Plus & { hParent: IBaseNpc_Plus, IsDummy: boolean, tIlls: any[], iActivePct: number };
