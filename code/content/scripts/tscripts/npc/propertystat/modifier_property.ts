...
export class modifier_property extends BaseModifier_Plus {
     ...
     * @returns
     */
    static SumProps(target: IBaseNpc_Plus, event: any, ...k: Array<GameEnum.Property.Enum_MODIFIER_PROPERTY>): number {
        let _r = 0;
    ...
    DeclareFunctions(): modifierfunction[] {
        return Array.from(GameEnum.Property.CustomDeclarePropertyEvent);
    }
    /**
     * 额外基础攻击力
     * @returns
