...
export class modifier_illusion extends BaseModifier_Plus {
     ...
     * @returns
     */
    static CreateIllusion(sUnitName: string, hCaster: IBaseNpc_Plus, vLocation: Vector, fDuration: number, bFindClearSpace: boolean = true, iTeamNumber: DOTATeam_t = null) {
        if (!IsServer()) { return };
    ...
    static GetIllusionCount(hCaster: IBaseNpc_Plus) {
        return
    }
