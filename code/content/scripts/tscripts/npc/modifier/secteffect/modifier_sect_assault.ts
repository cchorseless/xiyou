...
@registerModifier()
export class modifier_sect_assault_base_a extends modifier_sect_effect_base {
...
@registerModifier()
export class modifier_sect_assault_base_b extends modifier_sect_effect_base {
    Init() {
        let phyarm = this.getSpecialData("phyarm");
        let magicarm = this.getSpecialData("magicarm");
        let duration = this.getSpecialData("duration");
