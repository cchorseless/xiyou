...
@registerModifier()
export class modifier_sect_control_base_a extends modifier_sect_effect_base {
    Init() {
...
@registerModifier()
export class modifier_sect_control_base_b extends modifier_sect_effect_base {
    Init() {
        let duration = this.getSpecialData("duration");
        let parent = this.GetParentPlus();
        let t = parent.TempData().sect_control || { duration: 0 };
