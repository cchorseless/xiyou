...
//     @registerModifier()
// export class modifier_generic_motion_controller extends BaseModifier_Plus {
...
//     } else {
//         me.SetOrigin(me.GetOrigin() + (this.horizontal_velocity * dt));
...
//     }
//     if (this.height) {
//         me.SetOrigin(me.GetOrigin() + Vector(0, 0, this.vertical_velocity) * dt);
