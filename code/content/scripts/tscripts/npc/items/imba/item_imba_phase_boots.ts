...
// 相位鞋
@registerAbility()
export class item_imba_phase_boots extends BaseItem_Plus {
    GetIntrinsicModifierName(): string {
        return "modifier_imba_phase_boots";
    }
    OnSpellStart(): void {
        let caster = this.GetCasterPlus();
        let ability = this;
        let sound_cast = "DOTA_Item.PhaseBoots.Activate";
        let modifier_boost = "modifier_imba_phase_boots_buff";
...
@registerModifier()
export class modifier_imba_phase_boots extends BaseModifier_Plus {
...
@registerModifier()
export class modifier_imba_phase_boots_buff extends BaseModifier_Plus {
    public caster: IBaseNpc_Plus;
    public ability: IBaseItem_Plus;
    ...
    BeCreated(p_0: any,): void {
        ...
        this.caster = this.GetCasterPlus();
        this.ability = this.GetItemPlus();
        this.particle_boost = "particles/item/boots/phase_boots_speed_boost.vpcf";
        this.particle_drain = "particles/item/boots/phase_boots_drain.vpcf";
