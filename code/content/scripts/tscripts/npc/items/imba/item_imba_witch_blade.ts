...
// 巫师之刃
@registerAbility()
export class item_imba_witch_blade extends BaseItem_Plus {
    ...
    GetIntrinsicModifierName(): string {
        return "modifier_item_imba_witch_blade";
    }
    ...
    OnSpellStart(): void {
        ...
        target.AddNewModifier(this.GetCasterPlus(), this, "modifier_item_imba_witch_blade_slow", {
...
@registerModifier()
export class modifier_item_imba_witch_blade_slow extends BaseModifier_Plus {
...
@registerModifier()
export class modifier_item_imba_witch_blade_root extends BaseModifier_Plus {
...
@registerModifier()
export class modifier_item_imba_witch_blade extends BaseModifier_Plus {
    IsHidden(): boolean {
        return true;
    }
    IsPurgable(): boolean {
