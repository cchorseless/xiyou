...
CC_OnAttackLanded(keys:ModifierAttackEvent):void {
    if (IsServer()) {
        ...
        TriumAttack(owner, keys.target, this.GetItemPlus(), "modifier_item_imba_triumvirate_stacks_debuff", "modifier_item_imba_triumvirate_stacks_buff", "modifier_item_imba_triumvirate_proc_debuff", "modifier_item_imba_triumvirate_proc_buff");
    }
}
}
@registerModifier()
...
BeCreated(p_0:any,):void {
    ...
    if (IsServer()) {
        ...
        for (const [_, modifier] of ipairs(lower_tier_modifiers)) {
