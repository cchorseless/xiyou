...
// 魔龙枪
@registerAbility()
export class item_imba_dragon_lance extends BaseItem_Plus {
    GetIntrinsicModifierName(): string {
        return "modifier_item_imba_dragon_lance";
    }
    ...
    OnSpellStart(): void {
        ...
        if (caster.GetTeamNumber() == target.GetTeamNumber()) {
            ...
            target.AddNewModifier(caster, ability, "modifier_item_imba_dragon_lance_force_ally", {
                duration: duration
            });
        } else {
            ...
            if (caster.IsRangedAttacker()) {
                target.AddNewModifier(caster, ability, "modifier_item_imba_dragon_lance_force_enemy_ranged", {
                    duration: duration
                });
                caster.AddNewModifier(target, ability, "modifier_item_imba_dragon_lance_force_self_ranged", {
                    duration: duration
                });
            } else {
                target.AddNewModifier(caster, ability, "modifier_item_imba_dragon_lance_force_enemy_melee", {
                    duration: duration
                });
                caster.AddNewModifier(target, ability, "modifier_item_imba_dragon_lance_force_self_melee", {
                    duration: duration
                });
            }
            if (this.GetPurchaseTime() != -1) {
                let god_piercing_modifier = caster.AddNewModifier(this.GetCasterPlus(), this, "modifier_item_imba_dragon_lance_god_piercing_ally", {
                    duration: this.GetSpecialValueFor("god_piercing_duration")
                }) as modifier_item_imba_dragon_lance_god_piercing_ally;
                if (god_piercing_modifier) {
                    god_piercing_modifier.enemy = target;
                    target.AddNewModifier(this.GetCasterPlus(), this, "modifier_item_imba_dragon_lance_god_piercing_enemy", {
                        duration: this.GetSpecialValueFor("god_piercing_duration")
                    });
            ...
            let buff = caster.AddNewModifier(caster, ability, "modifier_item_imba_dragon_lance_attack_speed", {
                duration: ability.GetSpecialValueFor("range_duration")
            }) as modifier_item_imba_dragon_lance_attack_speed;
            buff.target = target;
...
@registerModifier()
export class modifier_item_imba_dragon_lance extends BaseModifier_Plus {
    IsHidden(): boolean {
        return true;
    }
    IsPurgable(): boolean {
...
@registerModifier()
export class modifier_item_imba_dragon_lance_force_ally extends BaseModifierMotionHorizontal_Plus {
    public pfx: any;
    public angle: any;
            ...
            if (!this.attacked_target[enemy.entindex() + ""]) {
                ...
                if (enemy.IsRealUnit()) {
                    ...
                    if (god_piercing_modifier) {
                        ...
                        enemy.AddNewModifier(this.GetCasterPlus(), this.GetItemPlus(), "modifier_item_imba_dragon_lance_god_piercing_enemy", {
                            duration: this.GetItemPlus().GetSpecialValueFor("god_piercing_duration")
                        });
                        let particle = ResHelper.CreateParticleEx("particles/units/heroes/hero_lone_druid/lone_druid_spiritlink_cast.vpcf", ParticleAttachment_t.PATTACH_ABSORIGIN_FOLLOW, this.GetParentPlus());
...
@registerModifier()
export class modifier_item_imba_dragon_lance_force_enemy_ranged extends BaseModifierMotionHorizontal_Plus {
    public pfx: any;
    public angle: any;
    public distance: number;
    IsDebuff(): boolean {
...
@registerModifier()
export class modifier_item_imba_dragon_lance_force_self_ranged extends BaseModifierMotionHorizontal_Plus {
    public pfx: any;
    public angle: any;
    public distance: number;
    IsDebuff(): boolean {
...
@registerModifier()
export class modifier_item_imba_dragon_lance_force_enemy_melee extends BaseModifierMotionHorizontal_Plus {
    public pfx: any;
    public angle: any;
    public distance: number;
    IsDebuff(): boolean {
...
@registerModifier()
export class modifier_item_imba_dragon_lance_force_self_melee extends BaseModifierMotionHorizontal_Plus {
    public pfx: any;
    public angle: any;
    public distance: number;
    IsDebuff(): boolean {
...
@registerModifier()
export class modifier_item_imba_dragon_lance_attack_speed extends BaseModifier_Plus {
    public as: any;
    public ar: any;
...
@registerModifier()
export class modifier_item_imba_dragon_lance_god_piercing_ally extends BaseModifier_Plus {
    ...
    CC_OnHealReceived(keys: ModifierHealEvent): void {
        ...
        if (keys.unit == this.enemy && !keys.unit.HasModifier("modifier_item_imba_dragon_lance_god_piercing_ally")) {
...
@registerModifier()
export class modifier_item_imba_dragon_lance_god_piercing_enemy extends BaseModifier_Plus {
    IsHidden(): boolean {
        return true;
    }
    IsPurgable(): boolean {
