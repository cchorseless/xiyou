    ...
    OnSpellStart(): void {
        ...
        if (target) {
            ...
            if (moon_buff) {
                ...
                moon_buff = target.AddNewModifier(caster, this, "modifier_item_imba_moon_shard_active", {}) as modifier_item_imba_moon_shard_active;
            ...
            let moon = BaseItem_Plus.CreateItem("item_imba_moon_shard", caster.GetPlayerOwner(), caster.GetPlayerOwner());
