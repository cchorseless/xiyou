...
export class item_imba_necronomicon extends BaseItem_Plus {
    ...
    OnSpellStart(): void {
        ...
        let melee_summon = BaseNpc_Plus.CreateUnitByName(melee_summon_name, melee_loc, this.GetCasterPlus().GetTeam(), true, this.GetCasterPlus(), this.GetCasterPlus());
        let ranged_summon = BaseNpc_Plus.CreateUnitByName(ranged_summon_name, ranged_loc, this.GetCasterPlus().GetTeam(), true, this.GetCasterPlus(), this.GetCasterPlus());
        print("and this");
