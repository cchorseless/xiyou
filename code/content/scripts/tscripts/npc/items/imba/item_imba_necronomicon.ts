...
OnSpellStart():void {
    ...
    let melee_loc = RotatePosition(caster_loc, QAngle(0, 30, 0), caster_loc + caster_direction * 180);
    let ranged_loc = RotatePosition(caster_loc, QAngle(0, -30, 0), caster_loc + caster_direction * 180);
    ...
    let melee_summon = BaseNpc_Plus.CreateUnitByName(melee_summon_name, melee_loc, true, this.GetCasterPlus(), this.GetCasterPlus(), this.GetCasterPlus().GetTeam());
    let ranged_summon = BaseNpc_Plus.CreateUnitByName(ranged_summon_name, ranged_loc, true, this.GetCasterPlus(), this.GetCasterPlus(), this.GetCasterPlus().GetTeam());
    print("and this");
    ...
    print("Test 4");
    for (const [_, melee_ability] of ipairs(melee_abilities)) {
    ...
    for (const [_, ranged_ability] of ipairs(ranged_abilities)) {
