...
// 影刃
@registerAbility()
export class item_imba_invis_sword extends BaseItem_Plus {
    OnSpellStart(): void {
        ...
        this.AddTimer(fade_time, () => {
            ...
            caster.AddNewModifier(caster, this, "modifier_item_imba_invis_sword_invis", {
                duration: duration
            });
        });
    }
    GetIntrinsicModifierName(): string {
        return "modifier_item_imba_invis_sword_passive";
    }
}
@registerModifier()
export class modifier_item_imba_invis_sword_invis extends BaseModifier_Plus {
    ...
    BeCreated(p_0: any,): void {
        ...
        if (IsServer()) {
            if (!this.GetParentPlus().findBuff<modifier_item_imba_invis_sword_invis_flying_disabled>("modifier_item_imba_invis_sword_invis_flying_disabled")) {
    ...
    CC_OnAttack(params: ModifierAttackEvent): void {
        if (IsServer()) {
            if (params.attacker == this.GetParentPlus()) {
                ...
                params.target.AddNewModifier(params.attacker, ability, "modifier_item_imba_invis_sword_invis_turnrate_debuff", {
    ...
    BeDestroy(): void {
        if (IsServer()) {
            if (!this.GetParentPlus().findBuff("modifier_invis_sword_invis_flying_disabled")) {
...
@registerModifier()
export class modifier_item_imba_invis_sword_passive extends BaseModifier_Plus {
        ...
        if (IsServer()) {
            if (params.unit == this.GetParentPlus()) {
                ...
                if (GFuncEntity.IsHeroDamage(params.attacker, params.damage)) {
                    parent.AddNewModifier(parent, this.GetItemPlus(), "modifier_item_imba_invis_sword_invis_flying_disabled", {
...
@registerModifier()
export class modifier_item_imba_invis_sword_invis_flying_disabled extends BaseModifier_Plus {
    IsDebuff(): boolean {
        return false;
    }
    IsHidden(): boolean {
    ...
    BeDestroy(): void {
        if (IsServer()) {
            if (this.GetParentPlus().findBuff<modifier_item_imba_invis_sword_invis>("modifier_item_imba_invis_sword_invis")) {
                this.GetParentPlus().SetMoveCapability(DOTAUnitMoveCapability_t.DOTA_UNIT_CAP_MOVE_FLY);
            }
        }
    }
...
@registerModifier()
export class modifier_item_imba_invis_sword_invis_turnrate_debuff extends BaseModifier_Plus {
    public turnrate: any;
    IsDebuff(): boolean {
        return true;
    }
    ...
    GetEffectName(): string {
        return "particles/item/invis_sword/invis_sword_panic_debuff.vpcf";
    }
