...
BeCreated(p_0:any,):void {
    ...
    let overhead_particle = ResHelper.CreateParticleEx(overhead_particle, ParticleAttachment_t.PATTACH_OVERHEAD_FOLLOW, this.GetParentPlus());
    this.AddParticle(overhead_particle, false, false, -1, false, false);
...
CheckState():Partial<Record<modifierstate,boolean>> {
    ...
    for (let shop_type = 1; shop_type <= 7; shop_type += 1) {
