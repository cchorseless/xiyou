...
BeCreated(p_0:any,):void {
    ...
    this.parent.smoke_of_deceit_surprise_atk_damage_pct = this.surprise_atk_damage_pct;
    this.parent.smoke_of_deceit_surprise_atk_spell_amp = this.surprise_atk_spell_amp;
    this.parent.smoke_of_deceit_surprise_atk_hit_count = this.surprise_atk_hit_count;
    if (IsServer()) {
...
BeCreated(p_0:any,):void {
    ...
    this.caster = this.GetCasterPlus();
    this.parent = this.GetParentPlus();
    this.surprise_atk_damage_pct = this.parent.smoke_of_deceit_surprise_atk_damage_pct;
    this.surprise_atk_spell_amp = this.parent.smoke_of_deceit_surprise_atk_spell_amp;
    this.surprise_atk_hit_count = this.parent.smoke_of_deceit_surprise_atk_hit_count;
    this.parent.smoke_of_deceit_surprise_atk_damage_pct = undefined;
    this.parent.smoke_of_deceit_surprise_atk_spell_amp = undefined;
    this.parent.smoke_of_deceit_surprise_atk_hit_count = undefined;
