...
CC_OnAttack(params:ModifierAttackEvent):void {
    if (params.attacker == this.parent && this.parent.IsRealHero() && this.parent.GetAgility) {
        if (this.item.IsCooldownReady() && (this.CheckUniqueValue(1, {
            1: "modifier_imba_starfury_passive"
        }) == 1)) {
            ...
            if (hero.IsRangedAttacker()) {
                ...
                for (let i = 1; i <= 3; i += 1) {
                    ...
                    if (i == 1) {
                        direction = RotateVector2D(direction, this.ranged_proj_angle, true);
                    } else if (i == 2) {
                        direction = RotateVector2D(direction, -this.ranged_proj_angle, true);
                    }
                    ...
                    let projectile = {
                        ...
                        Source: hero,
                        fExpireTime: 8.0,
                        vVelocity: direction * this.projectile_speed,
                        ...
                        OnUnitHit: function (self, unit) {
                            ...
                            params.hCaster = hero;
                            params.hTarget = unit;
                            ProjectileHit(params, undefined, );
                        }
                    }
                ...
                if (enemy != params.target) {
                    ...
                    projectile = {
                        ...
                        OnProjectileHitUnit: function (params, projectileID) {
                            params.damage = damage;
                            params.damage_type = damage_type;
                            ProjectileHit(params, projectileID, );
                        }
                    }
