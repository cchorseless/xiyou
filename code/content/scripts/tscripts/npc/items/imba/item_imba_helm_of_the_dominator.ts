...
// 支配头盔
@registerAbility()
export class item_imba_helm_of_the_dominator extends BaseItem_Plus {
    GetIntrinsicModifierName(): string {
        return "item_imba_helm_of_the_dominator_passive";
    }
    OnSpellStart(): void {
        if (!IsServer()) {
            return;
...
@registerModifier()
export class item_imba_helm_of_the_dominator_passive extends BaseModifier_Plus {
    IsHidden(): boolean {
        return true;
    }
...
@registerModifier()
export class item_imba_helm_of_the_dominator_buff extends BaseModifier_Plus {
