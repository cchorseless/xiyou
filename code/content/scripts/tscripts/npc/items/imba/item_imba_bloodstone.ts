...
@registerAbility()
export class item_imba_bloodstone extends BaseItem_Plus {
    public caster: IBaseNpc_Plus;
    public restore_duration: number;
    initialized: boolean = false;
    GetIntrinsicModifierName(): string {
        return "modifier_item_imba_bloodstone";
    }
    ...
    OnSpellStart(): void {
        ...
        this.GetCasterPlus().AddNewModifier(this.GetCasterPlus(), this, "modifier_item_imba_bloodstone_active", {
            duration: this.restore_duration
        });
        this.GetCasterPlus().AddNewModifier(this.GetCasterPlus(), this, "modifier_item_imba_bloodstone_active_cdr", {
            duration: this.GetSpecialValueFor("active_duration")
        });
    }
}
@registerModifier()
export class modifier_item_imba_bloodstone extends BaseModifier_Plus {
    public ability: item_imba_bloodstone;
...
@registerModifier()
export class modifier_item_imba_bloodstone_active extends BaseModifier_Plus {
    ...
    OnIntervalThink(): void {
        if (!this.GetParentPlus().HasModifier("modifier_item_imba_bloodstone_min_health_null")) {
            this.GetParentPlus().AddNewModifier(this.GetCasterPlus(), this.GetItemPlus(), "modifier_item_imba_bloodstone_min_health_null", {
...
@registerModifier()
export class modifier_item_imba_bloodstone_active_cdr extends BaseModifier_Plus {
...
@registerModifier()
export class modifier_item_imba_bloodstone_min_health_null extends BaseModifier_Plus {
    IgnoreTenacity() {
        return true;
    }
    IsDebuff(): boolean {
