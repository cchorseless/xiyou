...
//                 }
//                 if (info.vSpawnOrigin && info.vSpawnOrigin.unit) {
//                     let attach = info.vSpawnOrigin.unit.ScriptLookupAttachment(info.vSpawnOrigin.attach);
//                     let attachPos = info.vSpawnOrigin.unit.GetAttachmentOrigin(attach);
//                     projectile.vSpawnOrigin = attachPos + (projectile.vSpawnOrigin.offset || Vector(0, 0, 0));
//                 } else {
...
//                         for (const [k, v] of ipairs(this.ControlPoints)) {
//                             ParticleManager.SetParticleControl(this.id, k, v);
//                         }
//                         for (const [k, v] of ipairs(this.ControlPointForwards)) {
//                             ParticleManager.SetParticleControlForward(this.id, k, v);
//                         }
//                         for (const [k, v] of ipairs(this.ControlPointOrientations)) {
//                             ParticleManager.SetParticleControlOrientation(this.id, k, v[1], v[2], v[3]);
//                         }
//                         for (const [k, v] of ipairs(this.ControlPointEntityAttaches)) {
//                             let unit = v.unit || this.Source;
//                             let pattach = v.pattach || ParticleAttachment_t.PATTACH_CUSTOMORIGIN;
//                             let attachPoint = v.attachPoint;
//                             let origin = v.origin || newPos || this.pos + this.vel;
//                             ParticleManager.SetParticleControlEnt(this.id, k, unit, pattach, attachPoint, origin, true);
//                         }
//                         ParticleManager.SetParticleControl(this.id, this.iPositionCP, newPos || this.pos + this.vel);
//                         if (this.ControlPointForwards[1] == undefined && this.ControlPointOrientations[1] == undefined) {
...
//                                 this.SetVelocity(((-2 * vel.Dot(normal) * normal) + vel) * 30, subpos);
//                                 return;
//                             }
//                         }
//                     }
...
//                             }
//                             return;
//                         } else if (this.GroundBehavior == ProjectileHelper.ELineProjectBehavior.PROJECTILES_BOUNCE && this.changes > 0 && curTime >= projectile.changeTime) {
//                             if (this.OnGroundHit) {
//                                 this.OnGroundHit.runWith([this, ground])
//                             }
...
//                             this.SetVelocity(((-2 * vel.Dot(normal) * normal) + vel) * 30, subpos);
//                             return;
//                         } else if (this.GroundBehavior == ProjectileHelper.ELineProjectBehavior.PROJECTILES_FOLLOW && projectile.changes > 0 && curTime >= projectile.changeTime) {
...
//                                     this.OnGroundHit.runWith([this, ground])
//                                 }
//                                 this.SetVelocity(velLength * 30 * slope, subpos);
//                             }
//                             return;
//                         }
//                     }
