...
export class ai_creature_roamer {
    ...
    // public static awake(entity: IBaseNpc_Plus) {
    ...
    //     }, 0)
    // }
    // public static aiThink(entity: IBaseNpc_Plus) {
    //     if (!entity.IsAlive()) {
    //         return
    //     }
    ...
    // public static CheckIfHasAggro(entity: IBaseNpc_Plus) {
    ...
    // }
    // public static PlayRoarSound(entity: IBaseNpc_Plus) {
    ...
    // public static ShoutInRadius(entity: IBaseNpc_Plus) {
    ...
    // public static RoamBetweenWaypoints(entity: IBaseNpc_Plus) {
