    ...
    onAwake(...args: any[]): void {
        ...
        switch (DifficultyState.DifficultyChapter) {
            case DifficultyConfig.EDifficultyChapter.Difficulty_0:
                ...
                break;
            case DifficultyConfig.EDifficultyChapter.Difficulty_1:
            case DifficultyConfig.EDifficultyChapter.Difficulty_2:
            case DifficultyConfig.EDifficultyChapter.Difficulty_3:
            case DifficultyConfig.EDifficultyChapter.Difficulty_4:
            case DifficultyConfig.EDifficultyChapter.Difficulty_5:
            case DifficultyConfig.EDifficultyChapter.Difficulty_6:
            case DifficultyConfig.EDifficultyChapter.Difficulty_Endless:
