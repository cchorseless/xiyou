...
export class ability_propertytool extends BaseAbility_Plus {
    ...
    GetAbilityTextureName(): string {
        if (ability_propertytool.call_ability != null) {
            let hAbility = EntIndexToHScript(ability_propertytool.call_ability) as BaseAbility_Plus;
        ...
        if (ability_propertytool.call_unit != null) {
            let hUnit = EntIndexToHScript(ability_propertytool.call_unit) as BaseNpc_Plus;
