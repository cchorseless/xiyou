...
export class modifier_poison extends BaseModifier_Plus {
    ...
    tPoisonerInfos: { poisoner: BaseNpc_Plus, ability: BaseAbility_Plus, stack_count: number }[];
    ...
    Init(params: ModifierTable) {
        if (IsServer()) {
            ...
            if (tPoisonInfo != null) {
                this.addTimer(params.duration || modifier_poison.POISON_DURATION, () => {
     ...
     * @param duration 持续时间
     */
    static Poison(htarget: BaseNpc_Plus, hCaster: BaseNpc_Plus, hAbility: BaseAbility_Plus, iCount: number, duration: number = modifier_poison.POISON_DURATION) {
        if (!IsServer()) { return };
     ...
     * @param fPercent
     */
    static PoisonActive(htarget: BaseNpc_Plus, hCaster: BaseNpc_Plus, hAbility: BaseAbility_Plus, fPercent: number) {
     ...
     * @returns
     */
    static GetPoisonStackCount(htarget: BaseNpc_Plus) {
    ...
    /**todo */
    static RemovePoison(htarget: BaseNpc_Plus) {
