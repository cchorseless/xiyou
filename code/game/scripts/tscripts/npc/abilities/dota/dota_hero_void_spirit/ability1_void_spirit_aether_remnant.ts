...
export class ability1_void_spirit_aether_remnant extends BaseAbility_Plus {
    ...
    UseIllusionSpell() {
        ...
        let hCaster = this.GetCasterPlus() as BaseNpc_Plus & { IsDummy: boolean, tIlls: any[], iActivePct: number };
    ...
    UseSpell(hCaster: BaseNpc_Plus, vTarget: Vector) {
        //  let hCaster = this.GetCasterPlus()
        //  let vTarget = this.GetCursorPosition()
...
export class modifier_void_spirit_1 extends BaseModifier_Plus {
    ...
    OnIntervalThink() {
        if (IsServer()) {
            ...
            let hCaster = ability.GetCasterPlus() as BaseNpc_Plus & { hParent: BaseNpc_Plus, IsDummy: boolean, tIlls: any[], iActivePct: number };
...
export class modifier_void_spirit_1_thinker extends BaseModifier_Plus {
    ...
    RootedEmmy(hTarget: BaseNpc_Plus) {
