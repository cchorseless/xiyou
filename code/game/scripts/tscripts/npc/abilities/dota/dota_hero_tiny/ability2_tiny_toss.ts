...
export class ability2_tiny_toss extends BaseAbility_Plus {
    ...
    Toss(hTarget: BaseNpc_Plus & { iBonusTossTimes: number }) {
...
export class modifier_tiny_2_toss extends BaseModifierMotionBoth_Plus {
    ...
    OnCreated(params: ModifierTable) {
        ...
        if (IsServer()) {
            ...
            this.hTossTarget = EntIndexToHScript(params.target_entindex || -1) as BaseNpc_Plus
    ...
    OnDestroy() {
        ...
        if (IsServer()) {
            ...
            let hParent = this.GetParentPlus() as BaseNpc_Plus & { iBonusTossTimes: number }
