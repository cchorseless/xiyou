...
export class ability5_snapfire_spit_creep extends BaseAbility_Plus {
    ...
    OnProjectileHit_ExtraData(hThinker: BaseNpc_Plus, vLocation: Vector, ExtraData: any) {
        if (GameFunc.IsValid(hThinker)) {
            ...
            for (let hTarget of (tTargets)) {
                // 血盆大口
                // let hModifier = modifier_snapfire_3_scepter_buff.findIn(hCaster) as BaseModifier_Plus;
