...
import { modifier_ember_spirit_2_disarmed, modifier_ember_spirit_2_invulnerability, modifier_ember_spirit_2_marker, modifier_ember_spirit_2_particle_ember_spirit_sleightoffist_tgt, modifier_ember_spirit_2_particle_ember_spirit_sleightoffist_trail, modifier_ember_spirit_2_particle_ember_spirit_sleight_of_fist_cast } from "./ability2_ember_spirit_sleight_of_fist";
...
export class ability6_ember_spirit_fire_remnant extends BaseAbility_Plus {
    ...
    CreateRemnant() {
        ...
        let hRemnant = CreateUnitByName(hCaster.GetUnitName(), vStartPosition, false, hHero, hHero, hCaster.GetTeamNumber())
    ...
    Ability1(sourcehAbility: BaseAbility_Plus, hRemnant: BaseNpc_Plus) {
        let hCaster = this.GetCasterPlus()
        if (GameFunc.IsValid(hRemnant)) {
    ...
    Ability2(sourcehAbility: BaseAbility_Plus, hRemnant: BaseNpc_Plus) {
        let hCaster = this.GetCasterPlus()
        if (GameFunc.IsValid(hRemnant)) {
    ...
    Ability3(sourceAbility: BaseAbility_Plus, hRemnant: BaseNpc_Plus) {
        let hCaster = this.GetCasterPlus()
        if (GameFunc.IsValid(hRemnant)) {
...
export class modifier_ember_spirit_1_debuff_ember_spirit_4 extends BaseModifier_Plus {
    ...
    OnCreated(params: ModifierTable) {
        ...
        if (IsServer()) {
            ...
            this.modifier_truesight = modifier_truesight.apply(this.GetParentPlus(), this.GetCasterPlus(), this.GetAbilityPlus(), { duration: this.GetDuration() }) as BaseModifier_Plus
        } else {
...
export class modifier_ember_spirit_6_enemy_arua_debuff_ember_spirit_4 extends BaseModifier_Plus {
    ...
    Init(params: ModifierTable) {
        let hCaster = this.GetAuraOwner() as BaseNpc_Plus
        let hParent = this.GetParentPlus()
        if (IsServer()) {
