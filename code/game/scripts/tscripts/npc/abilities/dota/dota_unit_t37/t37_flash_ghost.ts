...
export class t37_flash_ghost extends BaseAbility_Plus {
    ...
    OnProjectileHit(hTarget: BaseNpc_Plus, vLocation: Vector) {
        if (GameFunc.IsValid(hTarget)) {
            ...
            // let modifier_combination_t37_netherworld_assault = modifier_combination_t37_netherworld_assault.findIn(hCaster) as BaseModifier_Plus;
            // todo:范围爆炸特效
            for (let hTarget of (tTarget)) {
                ...
                // let hNetherworld = modifier_combination_t37_netherworld_assault.GetAbilityPlus() as BaseAbility_Plus
    ...
    HasNihilityBuff(hTarget: BaseNpc_Plus) {
