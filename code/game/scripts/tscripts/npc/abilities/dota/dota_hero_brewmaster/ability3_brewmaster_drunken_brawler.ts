...
export class modifier_brewmaster_3 extends BaseModifier_Plus {
    ...
    AddAbility(sAbilityName: string, hUnit: BaseNpc_Plus) {
        let hParent = this.GetParentPlus()
    ...
    OnIntervalThink() {
        if (IsServer()) {
            ...
            //             }
            //             // 天赋提升30%全伤害
            //             let hModifier = hParent.FindModifierByNameAndCaster("modifier_brewmaster_3_amplify_damage", hUnit) as BaseModifier_Plus
