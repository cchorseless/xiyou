...
export class t18_frost_nova extends BaseAbility_Plus {
    ...
    GetAOERadius() {
        ...
        // let modifier_combination_t18_frost_condense = modifier_combination_t18_frost_condense.findIn(hCaster) as BaseModifier_Plus & { extra_radius: number };
...
export class modifier_t18_frost_nova_particle extends modifier_particle {
    OnCreated(params: ModifierTable) {
        ...
        let vPosition = hParent.GetAbsOrigin()
        let hAbility = this.GetAbilityPlus()
        // let hModifier = modifier_combination_t18_frost_condense.findIn(hCaster) as BaseModifier_Plus & { extra_radius: number };
