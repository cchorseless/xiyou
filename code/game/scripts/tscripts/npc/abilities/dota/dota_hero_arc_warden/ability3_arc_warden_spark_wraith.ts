...
export class ability3_arc_warden_spark_wraith extends BaseAbility_Plus {
    ...
    LinkCloneProperties(hCaster: BaseNpc_Plus, hClone: BaseNpc_Plus) {
        ...
        //  可复制光环
        let tModifiers = hCaster.FindAllModifiers() as BaseModifier_Plus[];
        ...
        //  天赋极限宝典
        // let buff  = modifier_item_tome_of_stats.findIn(  hCaster ) as BaseModifier_Plus;
