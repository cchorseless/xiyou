...
@registerAbility()
export class ability1_pudge_meat_hook extends ActiveRootAbility {
    /**对应dota内的名字 */
    ...
    OnProjectileHit_ExtraData(hTarget: BaseNpc_Plus, vLocation: Vector, ExtraData: ModifierTable) {
