...
export const Data_lina_dragon_slave = {
    ...
    AbilitySpecial: {
        "01": { var_type: "FIELD_INTEGER", dragon_slave_speed: "1200" },
        "02": { var_type: "FIELD_INTEGER", dragon_slave_width_initial: "275" },
        "03": { var_type: "FIELD_INTEGER", dragon_slave_width_end: "200" },
        "04": { var_type: "FIELD_INTEGER", dragon_slave_distance: "1075" },
    },
    AbilityCastAnimation: "ACT_DOTA_CAST_ABILITY_1",
};

@registerAbility()
export class lina_1 extends BaseAbility_Plus {
    /**对应dota内的名字 */
...
export class modifier_lina_1 extends BaseModifier_Plus {
    ...
    OnIntervalThink() {
        if (IsServer()) {
            ...
            let position = AoiHelper.GetLinearMostTargetsPosition(
